...
public class LoanAssistant extends JFrame{
    ...
    Font myFont = new Font("Red", Font.PLAIN, 16);
	...
	balanceTextField.setBackground(Color.PINK);
	...
	interestTextField.setBackground(Color.PINK);
	...
	//frame design for loan Analysis
	...
	analysisTextArea.setBorder(BorderFactory.createLineBorder(Color.GREEN,3));
	analysisTextArea.setFont(new Font("Courier New", Font.PLAIN, 14));
	analysisTextArea.setEditable(false);
	analysisTextArea.setBackground(Color.YELLOW);
	gridConstraints = new GridBagConstraints();
	gridConstraints.gridx = 3;
	gridConstraints.gridy = 1;
	gridConstraints.gridheight = 4;
	gridConstraints.insets = new Insets(0, 100, 0, 100);
